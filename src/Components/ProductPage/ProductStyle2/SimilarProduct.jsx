  ...
  return (
    <>
        <div className="flex w-full items-center mb-[72px] flex-col">
          <div className="flex w-[85%] mt-[72px] mb-8 tablet:w-full tablet:mb-4 tablet:mt-6 tablet:px-8 max-[600px]:mb-2 max-[600px]:mt-6 max-[600px]:w-full max-[600px]:px-4 items-center justify-between">
