  ...
  return (
    <div className="w-full">
      {!error && !searchLoading && searchProducts.length === 0 ? (
        ...
        <div className=" mobile:flex-wrap md:justify-evenly xl:justify-start md:px-0 mobile:justify-center md:flex-row md:flex-wrap mobile:mt-[-14px] mobile:px-0 mobile:m-0 mobile:gap-2 md:gap-4 xl:gap-6 flex md:ml-0 xl:pl-10 flex-wrap w-full">
