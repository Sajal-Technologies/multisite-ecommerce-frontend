      ...
      >
        <SwiperSlide>
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] md:w-full flex items-center justify-center bg-gradient-to-br from-[#015F85] via-[#016A94] to-[#0187BD] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] mobile:w-full mobile:px-4 grid grid-cols-[70fr_30fr]">
              <div className="banner1 self-center ">
                <h3 className="tablet:text-lg text-white lg:text-2xl mobile:text-xs">
                  Get best online deals for mobile phones
                </h3>
                <h1 className="font-bold  tablet:text-[38px] leading-none lg:mb-2 tablet:mb-1 text-white lg:text-[64px] mobile:text-xl">
                  New Smartphones
                </h1>
                <h2 className="font-bold tablet:text-[28px] lg:mb-6  tablet:mb-4 uppercase text-white lg:text-[32px] mobile:text-xl">
                  UP to 60% OFF
                </h2>
                <Link to="/Smartphones">
                  <Button />
        ...
        <SwiperSlide>
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] md:w-full flex items-center justify-center bg-[#192030] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] mobile:w-full mobile:px-4 grid grid-cols-[70fr_30fr]">
              <div className="banner1 self-center ">
                <h3 className="tablet:text-lg text-white lg:text-2xl mobile:text-xs">
        ...
        <SwiperSlide>
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] md:w-full flex items-center justify-center bg-[#E6425E] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] mobile:w-full mobile:px-4 grid grid-cols-[70fr_30fr]">
              <div className="banner1 self-center ">
                <h3 className="tablet:text-lg text-white lg:text-2xl mobile:text-xs">
              ...
              <div className="">
                <img src={Tv} className="w-full h-full object-cover " alt="" />
              </div>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] md:w-full flex items-center justify-center  bg-[#F7C59F] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] mobile:w-full mobile:px-4 grid grid-cols-[70fr_30fr]">
              <div className="banner1 self-center ">
                <h3 className="tablet:text-lg text-white lg:text-2xl mobile:text-xs">
        ...
        <SwiperSlide>
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] md:w-full flex items-center justify-center bg-gradient-to-br from-[#292B2A] via-[#212322] to-[#757678] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] mobile:w-full mobile:px-4 grid grid-cols-[70fr_30fr]">
              <div className="banner1 self-center ">
                <h3 className="tablet:text-lg text-white lg:text-2xl mobile:text-xs">
          ...
          <div className="h-[25vw] mobile:h-[36vw] w-[100%] flex items-center justify-center bg-gradient-to-br from-[#292B2A] via-[#212322] to-[#757678] rounded-2xl mobile:rounded-none">
            <div className="h-[90%] w-[80%] flex justify-between">
              <div className="bl mobile:ml-[-5vw] mobile:self-center tablet:self-start">
                ...
                <h1 className="font-bold mt-[-.8vw] text-white tablet:text-[38px] lg:text-[64px] uppercase mobile:text-xl">
                  shop best gears
                </h1>
                <h2 className="font-bold mt-[-.8vw] mb-[1.8vw] uppercase text-white md:text-[28px] xl:text-[32px] mobile:text-xl">
                  UP to 60% OFF
