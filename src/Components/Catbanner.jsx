...
const Catbanner = () => {
  return (
    <>
      <div className="w-[418px] catbanner h-[200px] max-[600px]:inline-block max-[600px]:flex-shrink-0 max-[600px]:w-[114px] max-[600px]:h-[104px] relative bg-gradient-to-br from-[#015F85] via-[#05739e] to-[#19a5dc] rounded-lg overflow-hidden">
