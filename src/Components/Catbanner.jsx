...
const Catbanner = () => {
  return (
    <>
      <figure className="w-[418px] catbanner h-[200px] mobile:inline-block mobile:flex-shrink-0 mobile:w-[114px] mobile:h-[104px] relative bg-gradient-to-br from-[#015F85] via-[#05739e] to-[#19a5dc] rounded-lg overflow-hidden">
