...
const CatList = () => {
  return (
    <>
      <div className=" h-fit w-[64vw] items-center flex overflow-hidden gap-4 border-[1px] border-[#F2F2F2] rounded-2xl ">
        <Link to="/Product">
          <div className="imgcontainer flex gap-4 items-center justify-center h-[230px] w-[300px] bg-[#FAFEFF]">
